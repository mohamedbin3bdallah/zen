 ...
 */
  ...
  unset($information);
if (DEFINE_CUSTOM_LAMPS_STATUS <= 1) {
    $information[] = '<a href="http://click2egypt.com/zahereen/index.php?main_page=page&amp;id=3">' . BOX_INFORMATION_CUSTOM. '</a>';
  }
  if (DEFINE_FAQ_STATUS <= 1) {
    $information[] = '<a href="' . zen_href_link(FILENAME_FAQ) . '">' . BOX_INFORMATION_FAQ. '</a>';
  }
if (DEFINE_QUANTITYDISCOUNTS_PROMO_STATUS <= 1) {
    $information[] = '<a href="' . zen_href_link(FILENAME_QUANTITYDISCOUNTS_PROMO) . '">' . BOX_INFORMATION_QUANTITYDISCOUNTS_PROMO. '</a>';
  }
...
{
    $information[] = '<a href="http://click2egypt.com/zahereen/index.php?main_page=page&amp;id=1">' . BOX_INFORMATION_SHIP . '</a>';
  }
...
{
    $information[] = '<a href="http://click2egypt.com/zahereen/index.php?main_page=page&amp;id=2">' . BOX_INFORMATION_aboutus . '</a>';
  }
