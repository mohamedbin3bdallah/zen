...
<?php } //endif ?>
          ...
          <ul>
<?php  { ?>
            <li><?php echo '<a href="http://click2egypt.com/zahereen/index.php?main_page=page&amp;id=3">' . BOX_INFORMATION_CUSTOM . '</a>'; ?></li>
<?php } ?>
<?php  { ?>
            <li><?php echo '<a href="' . zen_href_link(FILENAME_FAQ) . '">' . BOX_INFORMATION_FAQ. '</a>'; ?></li>
<?php } ?>
<?php  { ?>
            <li><?php echo '<a href="http://click2egypt.com/zahereen/index.php?main_page=page&amp;id=1">' . BOX_INFORMATION_SHIP . '</a>'; ?></li>
<?php } ?>
...
<?php } ?>
<?php  { ?>
            <li><?php echo '<a href="http://click2egypt.com/zahereen/index.php?main_page=page&amp;id=2">' . BOX_INFORMATION_aboutus . '</a>'; ?></li>
<?php } ?>
