...
define('TEXT_INFORMATION', 'You may change your quantity by updating the number in the box and clicking the button with arrows. You also may delete items from the cart by clicking the basket icon. The check box is used to select item/items for a further action.');
