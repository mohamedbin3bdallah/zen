...
// information box text in sideboxes/information.php
  ...
  define('BOX_INFORMATION_SHIPPING', 'Returns');
define('BOX_INFORMATION_SHIP', 'Shipping');
  define('BOX_INFORMATION_CONTACT', 'Contact Us');
define('BOX_INFORMATION_aboutus', 'About Us');
define('BOX_INFORMATION_CUSTOM', 'Custom Lamps');
...
// banner_box
  define('BOX_HEADING_BANNER_BOX','Our Clients');
...
// set for login for prices
  define('TEXT_LOGIN_FOR_PRICE_PRICE','Login for Price');
...
// authorization pending
  define('TEXT_AUTHORIZATION_PENDING_PRICE', 'Login for Price');
